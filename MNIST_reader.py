...
def get_data(d):
    ...
    # sort test set (to make federated learning non i.i.d.)(different labels on different clients)
...
class Data:
    def __init__(self, save_dir, n):
        ...
        self.client_set = pickle.load(open(str(raw_directory) + '/clients/' + str(n) + '_clients.pkl', 'rb'))
